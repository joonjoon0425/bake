...
use bake_gym::env::GymFrozenLake;
...
pub fn main() {
    ...
    let env = GymFrozenLake::new(seed, &device, KwArgs::new());
    ...
    let mut eps_sch = LinearScheduler::new(1.0, 0.05, total_steps, 0.8);
    ...
    // evaluation
    let env = GymFrozenLake::new(seed, &device, KwArgs::new().add("render_mode", "human"));
    let mut tape = Tape::new(env);
